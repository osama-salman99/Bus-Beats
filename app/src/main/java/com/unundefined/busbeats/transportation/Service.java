...
public class Service extends Vehicle {
    ...
    private OnServiceReadyCallback activity;
    private int locationIndex;

    public Service(DocumentSnapshot document, OnServiceReadyCallback activity) {
        super(document);
    ...
    protected void fetchRoute() {
        ...
        storageReference
                .child("routes/services/" + routeId + ".txt")
                .getFile(tempFile)
